...
.. code-block:: php
    ...
    $client = new PvGuzzleHttp\Client(['base_uri' => 'http://httpbin.org']);
...
:Constant: ``PvGuzzleHttp\RequestOptions::ALLOW_REDIRECTS``
...
.. warning::
    ...
    ``PvGuzzleHttp\Middleware::redirect`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``PvGuzzleHttp\HandlerStack::create``.
...
:Types:
        ...
        - null
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::AUTH``
...
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::BODY``
...
- ``Psr\Http\Message\StreamInterface``
  ...
  .. code-block:: php
      ...
      $stream = PvGuzzleHttp\Psr7\stream_for('contents...');
...
:Types:
        ...
        - array
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::CERT``
...
:Types: ``PvGuzzleHttp\Cookie\CookieJarInterface``
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::COOKIES``

You must specify the cookies option as a
``PvGuzzleHttp\Cookie\CookieJarInterface`` or ``false``.

.. code-block:: php

    $jar = new \PvGuzzleHttp\Cookie\CookieJar();
    $client->request('GET', '/get', ['cookies' => $jar]);

.. warning::

    This option only has an effect if your handler has the
    ``PvGuzzleHttp\Middleware::cookies`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``PvGuzzleHttp\default_handler``.
...
:Types: float
:Default: ``0``
:Constant: ``PvGuzzleHttp\RequestOptions::CONNECT_TIMEOUT``
...
:Types:
        ...
        - ``fopen()`` resource
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::DEBUG``
...
:Types:
        ...
        - bool
:Default: ``true``
:Constant: ``PvGuzzleHttp\RequestOptions::DECODE_CONTENT``
...
:Types:
    ...
    - float
:Default: null
:Constant: ``PvGuzzleHttp\RequestOptions::DELAY``
...
:Types:
    ...
    - integer
:Default: ``1048576``
:Constant: ``PvGuzzleHttp\RequestOptions::EXPECT``
...
:Types: string
:Default: null
:Constant: ``PvGuzzleHttp\RequestOptions::FORCE_IP_RESOLVE``
...
:Types: array
:Constant: ``PvGuzzleHttp\RequestOptions::FORM_PARAMS``
...
:Types: array
:Defaults: None
:Constant: ``PvGuzzleHttp\RequestOptions::HEADERS``
...
.. code-block:: php
    ...
    $client = new PvGuzzleHttp\Client(['headers' => ['X-Foo' => 'Bar']]);
...
:Types: bool
:Default: ``true``
:Constant: ``PvGuzzleHttp\RequestOptions::HTTP_ERRORS``

.. code-block:: php

    $client->request('GET', '/status/500');
    // Throws a PvGuzzleHttp\Exception\ServerException
...
.. warning::
    ...
    This option only has an effect if your handler has the
    ``PvGuzzleHttp\Middleware::httpErrors`` middleware. This middleware is added
    by default when a client is created with no handler, and is added by
    default when creating a handler with ``PvGuzzleHttp\default_handler``.
...
:Constant: ``PvGuzzleHttp\RequestOptions::IDN_CONVERSION``
...
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::JSON``
...
:Types: array
:Constant: ``PvGuzzleHttp\RequestOptions::MULTIPART``
...
:Types: - callable
:Constant: ``PvGuzzleHttp\RequestOptions::ON_HEADERS``
...
be rejected with a ``PvGuzzleHttp\Exception\RequestException`` that wraps the
...
:Summary: ``on_stats`` allows you to get access to transfer statistics of a
    ...
    to send the request.
:Types: - callable
:Constant: ``PvGuzzleHttp\RequestOptions::ON_STATS``

The callable accepts a ``PvGuzzleHttp\TransferStats`` object.
...
:Types: - callable
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::PROGRESS``
...
:Types:
    ...
    - array
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::PROXY``
...
:Types:
    ...
    - string
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::QUERY``
...
:Constant: ``PvGuzzleHttp\RequestOptions::READ_TIMEOUT``
...
:Constant: ``PvGuzzleHttp\RequestOptions::SINK``
...
.. code-block:: php
    ...
    $resource = fopen('/path/to/file', 'w');
    $stream = PvGuzzleHttp\Psr7\stream_for($resource);
...
:Types:
        ...
        - array
:Default: None
:Constant: ``PvGuzzleHttp\RequestOptions::SSL_KEY``
...
:Types: bool
:Default: ``false``
:Constant: ``PvGuzzleHttp\RequestOptions::STREAM``
...
:Types: bool
:Default: none
:Constant: ``PvGuzzleHttp\RequestOptions::SYNCHRONOUS``
...
:Types:
    ...
    - string
:Default: ``true``
:Constant: ``PvGuzzleHttp\RequestOptions::VERIFY``
...
:Types: float
:Default: ``0``
:Constant: ``PvGuzzleHttp\RequestOptions::TIMEOUT``

.. code-block:: php

    // Timeout if a server does not return a response in 3.14 seconds.
    $client->request('GET', '/delay/5', ['timeout' => 3.14]);
    // PHP Fatal error:  Uncaught exception 'PvGuzzleHttp\Exception\RequestException'
...
:Types: string, float
:Default: ``1.1``
:Constant: ``PvGuzzleHttp\RequestOptions::VERSION``
